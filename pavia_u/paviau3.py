...
input_image = loadmat('H:\data\PaviaU.mat')['paviaU']
output_image = loadmat('H:\data\PaviaU_gt.mat')['paviaU_gt']

testdata = np.genfromtxt('H:\data\paviaU.csv',delimiter=',')
data_test = testdata[:,: -1]
label_test = testdata[:,-1]


clf = joblib.load('paviaU.m')
